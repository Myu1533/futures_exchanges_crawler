...
from dce import fetchContractBaseInfo as dceContractBaseInfo
from czce import fetchContractBaseInfo as czceContractBaseInfo
...
try:
    append_result = append_handler.append(dceContractBaseInfo())
    print("DCE: ", append_result)
except Exception as e:
    print("DCE Error: ", e) 

try:
    append_result = append_handler.append(czceContractBaseInfo())
